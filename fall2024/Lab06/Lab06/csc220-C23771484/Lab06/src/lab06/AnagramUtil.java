...
public class AnagramUtil {
    ...
    public static boolean areAnagrams(SortedString str1, SortedString str2){
        // TODO: Lab Part 2
    	if(str1.getSorted().equals(str2.getSorted()))
    		return true;
    ...
    public static String[] getLargestAnagramGroup(SortedString[] stringList){
    	...
    	MergeSort<SortedString> mSort = new MergeSort<>();
    	//SortedString[] sorted = null;

        /* sort the input string list */
    	if(stringList.length>1)
    		 stringList = mSort.sort(stringList);
    	// or stringList = iSort.sort(stringList); for insertion sort
    	...
    	if(stringList.length ==1) {
    		String[] r =  new String[stringList.length];
    		r[0] =  stringList[0].getSorted();
    		return r;
    	}
