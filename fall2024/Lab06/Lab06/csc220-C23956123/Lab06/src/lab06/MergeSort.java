...
public class MergeSort<E extends Comparable<E>> {
    ...
    public void fit(E[] array) {
        ...
        // Estimate the constant c based on the observed time and the theoretical O(n log n) value
        int n = array.length;
    ...
    private void sort(E[] array1, E[] array2, int first, int last) {
        ...
        // Copy the rest of a or b, whichever is not at the end.
           	while (a <= middle) array2[i++] = array1[a++];
            while (b <= last) array2[i++] = array1[b++];
