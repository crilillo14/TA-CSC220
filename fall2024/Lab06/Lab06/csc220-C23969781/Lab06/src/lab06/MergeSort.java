...
double startTime = System.nanoTime(); // Record start time in nanoseconds
    	...
    	double endTime = System.nanoTime(); // Record end time
 	    ...
 	    double elapsedTimeInMicroseconds = elapsedTime / 1000.0;
