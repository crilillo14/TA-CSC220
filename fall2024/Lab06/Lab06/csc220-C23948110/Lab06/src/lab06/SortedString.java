 ...
 */
public class SortedString implements Comparable<SortedString> { //keeps track of the unsorted word and the sorted word
    ...
    public SortedString(String unsorted) {
    	...
    	//this.sorted = sorter.sort(unsorted.toLowerCase().toCharArray());
    	 * 
    	 */
    ...
    public int compareTo(SortedString other) {
        // TODO: Lab Part 1.2
    	int comparisonValue = this.sorted.compareTo(other.sorted);
        return comparisonValue; // placeholder
    }
