...
public class MergeSort<E extends Comparable<E>> {
    ...
    public double O(int n) 
    {
        ...
        return (Math.log(n)/Math.log(2))*n; // placeholder
    }
    ...
    private void sort(E[] array1, E[] array2, int first, int last)
    {
        ...
        int i = first; //index for array2
        int a = first; //index for left half
        int b = middle + 1; //index for right half
