...
public class SortedString implements Comparable<SortedString> {
    ...
    public SortedString(String unsorted) {
    	...
    	// looping through the charArray and adding the shit to this.sorted SUIIII
    	this.sorted = "";
    	char[] charArray = unsorted.toLowerCase().toCharArray();
    	Arrays.sort(charArray);
    	for (int index = 0; index < charArray.length; index++) {
    		sorted += charArray[index];
    	}
    ...
    /**
     * Helper method to convert array of SortedStrings to Strings
     *
     * @param sortedStrings the input array of SortedStrings
     * @return the String array of the SortedString array
     */
    public static String[] toStrings(SortedString[] sortedStrings) {
    	String[] out = new String[sortedStrings.length];

    	for (int index = 0; index < out.length; index++) {
    		out[index] = sortedStrings[index].getUnsorted();
    	}
