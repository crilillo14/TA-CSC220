...
public class AnagramUtil {
    ...
    public static boolean areAnagrams(SortedString str1, SortedString str2){
        // TODO: Lab Part 2
    	//takes in 2 already sorted strings and returns true of they are anagrams
    ...
    public static String[] getLargestAnagramGroup(SortedString[] stringList){
    	...
    	if (stringList == null || stringList.length <= 1) {
            return new String[0];  // No anagram groups can be formed
        }
        ...
        */
        ...
        for (int j = 0; j < maxLength; j++) {
            toReturn[j] = stringList[end-maxLength+1+j].getUnsorted();
        }
