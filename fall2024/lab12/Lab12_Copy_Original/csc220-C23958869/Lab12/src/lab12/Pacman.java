...
public class Pacman {
	...
	*/
	private void backtrack(Node end){
		...
		Node current = end;
	    while (current.parent != null) { // Stop at the start node
	        if (current.content != 'G') { // Don't overwrite the goal
	            current.content = '.';
	        }
	...
	private void buildGraph() {
		...
		try {
			...
			String[] characters = topLine.split(" ");
			
			height = Integer.parseInt(characters[0]);
			width = Integer.parseInt(characters[1]);
	...
	public void solveBFS() {
	    ...
	    Node startNode = maze[startY][startX];
