...
public class Pacman {
	...
	//assignment info: BFS(queue) - Q = [s, pop and put neighbors in, pop and do again until goal is found
	//DFS(stack) 
	// wall is not neighbor, things visited not neighbors, 
	...
	*/
	...
	private void buildGraph() {
		...
		try {
			...
			// FILL IN
			String[] readDimensions = input.readLine().split(" "); 
			
			height = Integer.parseInt(readDimensions[0]); 
			width = Integer.parseInt(readDimensions[1]); 
