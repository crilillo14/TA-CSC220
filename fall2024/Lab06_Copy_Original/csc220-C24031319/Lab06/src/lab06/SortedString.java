...
public class SortedString implements Comparable<SortedString> {
    ...
    // The so;rted version of the original string
    ...
    public SortedString(String unsorted) {
        // TODO: Lab Part 1.1
    	this.unsorted = unsorted.toLowerCase(); 
    	char[] temp = this.unsorted.toCharArray();
    	Arrays.sort(temp);
    ...
    public int compareTo(SortedString other) {
        // TODO: Lab Part 1.2
    	String otherSorted = other.getSorted();
        return (this.sorted.compareTo(otherSorted)); 
    }
