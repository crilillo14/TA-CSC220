...
public class HeapTester {
    ...
    public static void main(String[] arg)
    {
        // ********************* TESTS FOR LAB ****************************//
         ...
         if (!maxHeap.IsEqual(arr1) || maxHeap.poll() != -1)
         ...
         MaxHeap maxHeapTest = new MaxHeap(8);
         maxHeapTest.offer(30);
         maxHeapTest.offer(20);
         maxHeapTest.offer(10);
         maxHeapTest.offer(16);
         maxHeapTest.offer(15);
         int[] arrTest = {20, 16, 10, 15, 0, 0, 0, 0};
         maxHeapTest.poll();
         if (!maxHeapTest.IsEqual(arrTest)) {
        	 System.err.println("TEST FAILED: poll test");
         }
     ...
     // ********************* TESTS FOR ASSIGNMENT ****************************//
         ...
         int[] arr19 = {16,23,64,23,76,100,1,-2,45,3,17,20};
         int[] arr19_2 = {-2, 1, 3, 16, 17, 20, 23, 23, 45, 64, 76, 100};
         MaxHeap maxHeap10 = new MaxHeap(12);
         maxHeap10.sort(arr19);
         if (!maxHeap10.IsEqual(arr19_2))
             System.err.println("TEST FAILED: sort 4");
