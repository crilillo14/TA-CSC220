...
//helper for Maxheap, check
    private void initializeHeapArray(int maxsize) {
...
//helper for poll, is this good??
    private void percDown(int index) {
        while (true) {
            ...
            // If largest is still the current index, we are done
            if (largest == index) {
                break;
            }
            ...
            // Move index down to the largest child position
            index = largest;
        }
    }
