...
public class MaxHeap {
    ...
    public MaxHeap(int[] arr){
        // TODO for Assignment Part 2 DONE
    ...
    public void offer(int element) {
        // TODO for Lab Part 3 DONE
    	theData [size] = element;
    	this.size+=1;
    	
    	int poschild = size -1;
    	int posparent = parent(poschild);
    	
    
    	while (theData[posparent] < element) {
    		swap (posparent, poschild);
    		poschild = posparent;
    		posparent = parent(poschild);
    	}
    }
