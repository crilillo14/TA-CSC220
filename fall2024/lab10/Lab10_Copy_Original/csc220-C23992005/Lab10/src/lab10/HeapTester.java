...
public class HeapTester {
    ...
    public static void main(String[] args)
    {
        ...
        System.out.println("Poll result: " + heap.poll()); // Expect 20
        System.out.println("Poll result: " + heap.poll()); // Expect 15
        System.out.println("Poll result: " + heap.poll()); // Expect 10
        System.out.println("Poll result: " + heap.poll()); // Expect -1 (empty)*/
     ...
     // ********************* TESTS FOR ASSIGNMENT ****************************//
        ...
        //printSideways(); // Just for debugging
