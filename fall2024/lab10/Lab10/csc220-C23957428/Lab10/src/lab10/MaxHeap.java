...
public class MaxHeap {
    ...
    protected void siftDown(int index) {
    	...
    	if ( leftChild(index) < size && theData[leftChild(index)] > theData[largest]) {
    		largest = leftChild(index);
    	}
    	
    	if ( rightChild(index) < size && theData[rightChild(index)] > theData[largest]) {
    		largest = rightChild(index);
    	}
    	
    	if ( largest != index ) {
    		int temp = theData[index];
    		theData[index] = theData[largest];
    		theData[largest] = temp;
