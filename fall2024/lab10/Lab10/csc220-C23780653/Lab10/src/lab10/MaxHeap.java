...
public class MaxHeap {
    ...
    public void offer(int element) {
    	...
    	while(curr > 0 && theData[curr] > theData[parent(curr)]) {
    ...
    public int poll() {
    	...
    	this.theData[0] = this.theData[this.size -1];
    	
    	this.size--;
    	
    	this.theData[this.size] = 0;
        ...
        while (true) {
            ...
            if (left < this.size && this.theData[left] > this.theData[largest]) {
                largest = left; 
            }

            if (right < this.size && this.theData[right] > this.theData[largest]) {
                largest = right; 
            }
