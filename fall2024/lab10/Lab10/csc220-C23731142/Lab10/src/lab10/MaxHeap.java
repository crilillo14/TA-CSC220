...
public class MaxHeap {
    ...
    public void offer(int element) {
    	...
    	if(theData[currentindex]>theData[parentindex] && parentindex<theData.length-1) {
    ...
    public int poll() {
    	...
    	while(currentindex<size-1) {
    		...
    		if(theData[leftindex]>theData[largestindex] && leftindex<size) {
    			
    			largestindex=leftindex;
    	
    		}
    		if(theData[rightindex]> theData[largestindex] && rightindex<size) {
    ...
    protected void siftDown(int index) {
    	...
    	while(index<size && !isLeaf(index)) {
    		
    		int leftchildindex = leftChild(index);
    		int rightchildindex= rightChild(index);
    		int parentindex = parent(index);
    		
    		if(theData[rightchildindex]>theData[parentindex]) {
    			
    			swap(rightchildindex,parentindex);
    			
    			siftDown(parentindex);
    			
    		} else if(theData[leftchildindex]>theData[rightchildindex]) {
