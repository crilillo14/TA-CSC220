...
public class MaxHeap {
    ...
    public void offer(int element) {
    	...
    	int currentPostion = size;
    	int parentPostion = parent(size);
    	
    	
    	
    	while (theData[parentPostion] < element) {
    		swap(parentPostion, currentPostion);
    		currentPostion = parentPostion;
    		parentPostion = parent(currentPostion);
