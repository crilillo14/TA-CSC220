...
//         heapify(size - 1);
    ...
    public void offer(int element) {
    	...
    	int current = size - 1;
    	while(theData[parent(current)] < theData[current]) {
    ...
    public int poll() {
    	...
    	while(theData[current] < theData[leftChild(current)] || theData[current] < theData[rightChild(current)]) {
