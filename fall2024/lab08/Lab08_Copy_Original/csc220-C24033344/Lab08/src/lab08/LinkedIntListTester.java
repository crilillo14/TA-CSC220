...
public class LinkedIntListTester {
	...
	public static void main(String[] args){
		...
		System.out.println("lastIndexOf method testing done.\n");
		...
		int[] arr7test = {};
		LinkedIntList list7test = new LinkedIntList(arr7test);
		list7test.removeAll(3);
		System.out.println("List 7.5: " + list7test);
		
		if (!list7test.toString().equals("[]"))
			System.err.println("TEST FAILED -- removeAll 5");
		
		int[] arr8test = {3, 3, 3, 3, 3, 3, 2, 3};
		LinkedIntList list8test = new LinkedIntList(arr8test);
		list8test.removeAll(3);
		System.out.println("List 8.5: " + list8test);
		
		if (!list8test.toString().equals("[2]"))
			System.err.println("TEST FAILED -- removeAll 6");
		
		System.out.println("removeAll method testing done.\n");
		...
		System.out.println("Stutter testing done.\n");
		...
		System.out.println("Shift testing done.\n");
