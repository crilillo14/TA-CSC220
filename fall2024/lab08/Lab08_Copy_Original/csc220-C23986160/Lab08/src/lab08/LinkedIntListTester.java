...
//		System.out.println("4" + list6);



		// my own tests
		LinkedIntList test1 = new LinkedIntList( new int[]{3, 3, 3, 3, 3, 3} );
		test1.removeAll(3);
//		System.out.println(test1);

		LinkedIntList test2 = new LinkedIntList( new int[]{3, 3, 3, 3, 3, 3, 1} );
		test2.removeAll(3);
//		System.out.println(test2);

		LinkedIntList test3 = new LinkedIntList( new int[]{3, 3, 1, 3, 3, 3, 3} );
		test3.removeAll(3);
//		System.out.println(test3);

		LinkedIntList test4 = new LinkedIntList( new int[]{3, 3, 1, 3, 3, 3, 3} );
		test4.removeAll(3);
...
//		System.out.println("STUTTER1 " + list7);
...
//		System.out.println("STUTTER2 " + list8);
...
//		System.out.println("STUTTER3 " + list9);
...
//		System.out.println("STUTTER4 " + list10);
...
//		System.out.println("SHIFT2 " + list12);
...
//		System.out.println("SHIFT4 " + list14);
