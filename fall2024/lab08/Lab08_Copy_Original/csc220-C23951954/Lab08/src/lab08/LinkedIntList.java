...
public class LinkedIntList {
	...
	public void stutter() {
		...
		while(current != null) {
			...
			current.next = copy;
			//doubles the lenght of the list
			current = current.next;
			current = current.next;
			//advances the linked list twice
			}
	}
	...
	public void shift() {
	    ...
	    ListNode current = front.next;     
	    ListNode evenIndex = front;   
	    ListNode oddIndex = current;      
	    while (oddIndex != null && oddIndex.next != null) {
	    	//should point to the next index and then go to the next even index
