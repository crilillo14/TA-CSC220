...
public class LinkedIntList {
    ...
    public int lastIndexOf(int value) {
    	...
    	//update last index each time to find
    	// current = current.next// move forward
    	// while loop (like size()) until null
    ...
    public void removeAll(int value) {
        ...
        // Removing all occurrences of the target value at the front of the list
    	...
    	//move both forward
    	//update previous to point at the one behind it
    	//previous.next() = current.next()
    	//be careful with edges
    	//front there is no previous (null)
    	//last there is no current.next -> null
    ...
    public void stutter() {
    	...
    	ListNode holdNode;
    	ListNode newDuplicate;
    	ListNode current = front;
    	while(current != null) {
    		ListNode duplicate = new ListNode(current.data); // Create a duplicate of the current node
            duplicate.next = current.next;  // Link duplicate to the next original node
            current.next = duplicate;       // Link current node to its duplicate
            current = duplicate.next;       // Move to the next original node (skipping the duplicate)    		
    	}// end of while statement
    	
    }// end of stutter class
    ...
    public void shift() {
    	...
    	ListNode even = front;        // Pointer to even-indexed nodes
        ListNode odd = front.next;    // Pointer to odd-indexed nodes
        ListNode oddHead = odd;       // Store the head of the odd-indexed nodes
    	...
    	even.next = oddHead;  // Attach the odd-indexed nodes to the end of the even nodes
    }// end of shift method
