...
public class LinkedIntList {
    ...
    public void removeAll(int value) {
    	...
    	while (current != null) {
            if (current.data == value) {
                ...
                // Move current forward after removal
                current = current.next;
            } else {
                // Move both previous and current forward if no removal occurs
                previous = current;
                current = current.next;
            }
    	}
    ...
    public void stutter() {
        // TODO: Assignment part 2.1
    	 ...
    	 while (current != null) {
    		 ListNode doubleSize = new ListNode(current.data, current.next);
    		 current.next = doubleSize;
    		 current = doubleSize.next;
