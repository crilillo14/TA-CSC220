...
public class LinkedIntList {
    ...
    public void stutter() {
       	...
       	while (currentNode != null) {
       		ListNode duplicateNode = new ListNode(currentNode.data);
       		duplicateNode.next = currentNode.next;
       		currentNode.next = duplicateNode;
       		
       		currentNode = duplicateNode.next;
       	}
    }
    ...
    public void shift() {
        ...
        if (size % 2 == 1) {
        	currentNode.next.next = oddStart;
        	currentNode.next = null;
        }
        else
        	currentNode.next = oddStart;
