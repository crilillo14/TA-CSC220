...
//		System.out.println("Index: " + list.lastIndexOf(5));
//		list.removeAll(5);
//		System.out.println("Index: " + list.lastIndexOf(5));
//		System.out.println("Size: " + list.size());
...
//		LinkedIntList list31 = new LinkedIntList();
//		list31.add(1);        
//		list31.add(5); 
//		list31.add(3); 
//		list31.add(2);
//		list31.add(4);
//
//		System.out.println("Size: " + list31.size());
//		list31.shift();
//		System.out.println("Size: " + list31.size());
//		System.out.println(list31.lastIndexOf(5));
//
//	
