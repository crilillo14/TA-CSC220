...
//    	ListNode last = front;
//    	if (front.data == value && front.next == null) 
//    		front = null;
//    	while(last.next != null) {
//    		if (front ==last && last.data == value)
//    			front = last.next;
//    		else {
...
//    	if(last.data == value && last.next == null)
//    		front =null;
//    	while(last.next!= null) {
//    		ListNode current = last.next;
//    		if (last.data == value && current.next!=null) {
...
//    	}
    ...
    public void stutter() {
    	...
    	while(current!= null) {
    		...
    		current.next = new ListNode(current.data,temp);
    		current =temp;
    	}
    }
    ...
    public void shift() {
        ...
        ListNode current =front;
        ListNode firstOdd=front.next;
        //firstOdd.next = null;
        ListNode lastOdd = firstOdd;
        ListNode firstEven=front;
        //firstEven.next = null;
