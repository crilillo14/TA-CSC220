...
public class LinkedIntList {
    ...
    public void stutter() {
        ...
        while (current != null) {
            ...
            current.next = new ListNode(current.data, next);
    ...
    public void shift() {
        // TODO: Assignment part 2.2
    	 ...
    	 if (front == null || front.next == null) {
    	    ...
    	    ListNode evenPointer = front; 
    	    ListNode oddPointer = front.next; 
    	    
    	    ListNode oddHead = oddPointer; 

    	    while (evenPointer != null && oddPointer != null && oddPointer.next != null) {
