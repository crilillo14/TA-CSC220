...
public class LinkedIntList {
    ...
    public void stutter() {
    	...
    	ListNode current = front;
    	while(current.next!=null && current!=null) {
        	ListNode newl = new ListNode(current.data);
    ...
    public void shift() {
    	...
    	ListNode current = front;
    	ListNode oddindex = front.next;
    	ListNode oddhead = oddindex;
    	if(current==null || oddindex == null) {
    		return;

    	}
    	
    	while(oddindex!=null || oddindex.next!=null) {
    		current.next = oddindex.next;
    		current = current.next;
    		oddindex.next = current.next;
