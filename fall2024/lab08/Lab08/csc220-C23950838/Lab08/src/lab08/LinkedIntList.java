...
public class LinkedIntList {
    ...
    public void removeAll(int value) {
    	...
    	// System.out.println(toString()); // For testing
    ...
    public void stutter() {
    	...
    	for (index = 0; index < originalSize; ++index) {
    		...
    		add((2 * index) + 1, nodeAt(2 * index).data);
    ...
    public void shift() {
    	...
    	int permanentSize = size();
    	
    	for (index = 1; index <= permanentSize / 2; ++index) {
    		
        	currentNode = nodeAt(index);
        	otherNode = nodeAt(index - 1);
