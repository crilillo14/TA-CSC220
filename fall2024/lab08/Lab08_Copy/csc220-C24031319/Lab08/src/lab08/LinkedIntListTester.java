...
public class LinkedIntListTester {
	...
	public static void main(String[] args){
		...
		System.out.println("removeAll 1: " + list3.toString());
		...
		System.out.println("removeAll 2: " + list4.toString());
		...
		System.out.println("removeAll 3: " + list5.toString());
		...
		System.out.println("removeAll 4: " + list6.toString());
		...
		//test empty list
		int[] arr0 = {};
		LinkedIntList list0 = new LinkedIntList(arr0);
		list6.removeAll(3);
		System.out.println(list0.toString()); //should return empty
		System.out.println(list0.lastIndexOf(1));
		...
		System.out.println("stutter 3: " + list9.toString());
		...
		list12.shift();
		System.out.println("shift 2: " + list12);
		...
		System.out.println("shift 3: " + list13.toString());
		...
		System.out.println("shift 4: " + list14.toString());
