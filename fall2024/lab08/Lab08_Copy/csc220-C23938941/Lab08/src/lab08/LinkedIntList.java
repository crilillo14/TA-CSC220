...
public class LinkedIntList {
    ...
    public void add(int index, int value) {
        if (index == 0) {
            ...
            //Creating the new value to add at the index specified
    ...
    public void removeAll(int value) {
    	...
    	// while the front node is the target value, go to next
        ...
        while (current != null && current.next != null) {
        	// Check if the value is equal to the value to remove
            if (current.next.data == value) {
                current.next = current.next.next;
            // If the value is not equal, then don't do it
            } else {
                current = current.next;
            }
        }
    ...
    public void stutter() {
        ...
        while (current != null) {
        	// Adding the new index after each value as a duplicate
        ...
        while (current != null) {
        	...
        	// If the index is odd
        		...
        		if (oddStart == null) {
        			...
        			// Moves the non-null odd index to the end
                    oddEnd.next = current;
                    oddEnd = oddEnd.next;
                }
            
        	// Keeps the even indices the same and just moves up by one index
        	} else {
            ...
            // Alternating indices switches from odd and even
        
        }
        
        // Increment for next odd
