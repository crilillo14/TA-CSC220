...
public class LinkedIntList {
    ...
    public void stutter() {
        ...
        // Traverse the list and duplicate each element
        while (current != null) {
            // Create a new node with the same data as the current node
            ListNode duplicate = new ListNode(current.data);
            
            // Insert the duplicate node right after the current node
            duplicate.next = current.next;
            current.next = duplicate;
            
            // Move to the next original node (skipping the duplicate)
    ...
    public void shift() {
        ...
        // Separate the nodes at odd-index positions into a new sublist
        ListNode even = front;              // This will hold the even-indexed nodes
        ListNode odd = front.next;          // This will hold the odd-indexed nodes
        ListNode oddHead = odd;             // Save the head of the odd list

        // Traverse the list, alternating between even and odd nodes
        ...
        // After rearranging, attach the odd list at the end of the even list
        even.next = oddHead;
    }
