...
//    		current = current.next;
    ...
    public void stutter() {
        ...
        while (current != null) {
            ...
            // Move to the next original node (skip over the duplicate)
    ...
    public void shift() {
        ...
        ListNode evenCurrent = evenStart;
        ListNode oddCurrent = oddStart;

        // Separate the odd and even index nodes
        ...
        // attach the odd list to the end of the even list
