...
public class LinkedIntList {
    ...
    //current to beginning
    //while current is not null, we did something and increased current
     ...
     */
    //move current forward, increase current index
    //size method is a good starting point
    ...
    //let previous = current, then I let current = current.next
    ...
    public void shift() {
    	...
    	if (front == null || front.next == null) {
            return;  // List is empty or has only one element, nothing to shift
        }

        ListNode oddStart = null;  // Head of the odd-indexed elements list
        ListNode oddEnd = null;    // Tail of the odd-indexed elements list
        ListNode evenStart = front;  // Head of the even-indexed elements list
        ListNode evenEnd = front;    // Tail of the even-indexed elements list

        ListNode current = front.next;  // Start at index 1 (odd index)
        boolean isOdd = true;
        ...
        while (current != null) {
            ...
            current = current.next;
            isOdd = !isOdd;  // Alternate between odd and even
        }

        // Close the even list and append the odd list to it
        evenEnd.next = oddStart;
        
        // Ensure the last node in the odd list points to null
        if (oddEnd != null) {
            oddEnd.next = null;
    }
