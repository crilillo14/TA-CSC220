...
public class LinkedIntListTester {
	...
	public static void main(String[] args){
		...
		if (list1.lastIndexOf(18) != 6)
			System.err.println("TEST FAILED -- lastIndexOf 1 (" + list1.lastIndexOf(18) + ")");		
		
		int[] arr2 = {1, 18, 2, 7, 18, 18, 39, 18, 40, 18};
		LinkedIntList list2 = new LinkedIntList(arr2);
		
		if (list2.lastIndexOf(18) != 9)
			System.err.println("TEST FAILED -- lastIndexOf 2 (" + list2.lastIndexOf(18) + ")");
				
		if (list2.lastIndexOf(7) != 3)
			System.err.println("TEST FAILED -- lastIndexOf 3 (" + list2.lastIndexOf(7) + ")");		
				
		if (list2.lastIndexOf(36) != -1)
			System.err.println("TEST FAILED -- lastIndexOf 4 (" + list2.lastIndexOf(36) + ")");	
		...
		if (!list3.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 1 " + list3.toString());
		...
		if (!list4.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 2 " + list4.toString());		
		...
		if (!list5.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 3 " + list5.toString());				
		...
		if (!list6.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 4 " + list6.toString());
		
		int[] arr6b = {3, 3, 9, 4, 2, 3, 3, 3, 8, 17, 4, 18, 3, 3};
		LinkedIntList list6b = new LinkedIntList(arr6b);
		list6b.removeAll(3);
		
		if (!list6b.toString().equals("[9, 4, 2, 8, 17, 4, 18]"))
			System.err.println("TEST FAILED -- removeAll 5 " + list6b.toString());
		...
		if (!list15.toString().equals("[1, 3, 5, 2, 4, 6]"))
