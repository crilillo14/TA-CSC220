...
public class AnagramUtil {
    ...
    public static String[] getLargestAnagramGroup(SortedString[] stringList){
    	...
    	InsertionSort<SortedString> sorting_algo = new InsertionSort<>();

        /* sort the input string list */
    	SortedString[] sortedList = sorting_algo.sort(stringList);
        ...
        */
        ...
        for (int k = 1; k < sortedList.length; k++) {
        	if (sortedList[k].getSorted().equals(sortedList[k - 1].getSorted())) {
        		length++;
        	}
        	else {
        		if (length > maxLength) {
