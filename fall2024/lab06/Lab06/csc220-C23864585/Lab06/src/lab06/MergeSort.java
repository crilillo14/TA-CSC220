...
public class MergeSort<E extends Comparable<E>> {
    ...
    public void fit(E[] array) {
        ...
        double timeInMicroseconds = (endTime - startTime) / 1000.0; // Convert to microseconds
        c = timeInMicroseconds / O(array.length); // Calculate constant c
    }
    ...
    public double predict(int n) {
        return c * O(n); // Predict the runtime
    }
