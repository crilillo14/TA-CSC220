...
public class MergeSort<E extends Comparable<E>> {
    ...
    public void fit(E[] array) {
    	...
    	c = ((end - start)*1.0) / O(n)*1.0;
    	System.out.println("Time"+(end-start)/10000.0+" c:"+c);
    }
    ...
    public E[] sort(E[] array) {
        ...
        // to be deleted begin block
//        System.out.println(" ");
//        System.out.print("** checked MergeSort to be deleted ** Merge sorted array = ");
//		for (int i = 0; i < sorted.length; i++) {		 
//			System.out.print(sorted[i] + " ");
//		}
		System.out.println(" ");
		// to be deleted end block
