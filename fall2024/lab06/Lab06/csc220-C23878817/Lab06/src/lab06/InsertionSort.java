...
public class InsertionSort<E extends Comparable<E>> {
    ...
    public void fit(E[] array) {
        //TODO: Lab Part 4.2
         ...
         // calculate c based on the O(n^2) complexity:
         c = timeTaken / Math.pow(n, 2);
         System.out.println("Estimated constant c for Insertion Sort: " + c);
    ...
    public double predict(int n) {
        ...
        //TODO: Lab Part 4.3
    	return c * Math.pow(n, 2); // Returns the predicted time in milliseconds
