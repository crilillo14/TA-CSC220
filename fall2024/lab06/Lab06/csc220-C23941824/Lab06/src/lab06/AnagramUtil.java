...
public class AnagramUtil {
    ...
    public static String[] getLargestAnagramGroup(SortedString[] stringList){
    	...
    	if (stringList.length <= 1) {
            ...
            toReturn[0] = stringList[0].getUnsorted();
            return toReturn;
        }
        ...
        /* Loop through stringList.
           ...
           length of this anagram group. part 1
           ...
           accordingly (see end, length, i, and MaxLength). part 2 + 3
        ...
        */
        ...
        for (int j = 0; j < maxLength; j++)
            toReturn[j] = stringList[end - maxLength + j + 1].getUnsorted();
