...
public class SortedString implements Comparable<SortedString> {
    ...
    public SortedString(String unsorted) {
        ...
        char[] characters = unsorted.toLowerCase().toCharArray(); // converts unsorted string to lower case

        Arrays.sort(characters); // sorts characters

        this.sorted = new String(characters); // convert back to string
    }
