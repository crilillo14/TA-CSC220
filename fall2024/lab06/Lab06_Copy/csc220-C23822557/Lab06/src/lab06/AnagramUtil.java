...
public class AnagramUtil {
    ...
    public static String[] getLargestAnagramGroup(SortedString[] stringList){
    	...
    	SortedString[] sortedList = insertionSort.sort(stringList); 


        /* The case where stringList is of size 1 or less */
    	if( sortedList == null || sortedList.length <= 1) {
    		
    		String[] returnList = new String[sortedList.length];
    		
    		for(int i = 0; i< sortedList.length; i++) {
    			
    			returnList[i] = sortedList[i].getUnsorted();   			
        ...
        */
        ...
        for(i = 0; i< sortedList.length - 1; i++) {
        	if(AnagramUtil.areAnagrams(sortedList[i], sortedList[i+1])) {
        		length = length + 1;
        	}
        	else {
        		if(length > maxLength) {
        ...
        */
        ...
        for (int j = 0; j < maxLength; j++) {
        	toReturn[j] = sortedList[end - maxLength + j + 1].getUnsorted();
        }
