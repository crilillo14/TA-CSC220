...
public class Tester {
 ...
 //one empty string, one non-empty string (not anagrams)
 ...
 //Shuffled anagrams ("listen" and "silent")
 ...
 //Shuffled anagrams with different cases ("Debit Card" and "Bad Credit")
 ...
 //Two different strings (not anagrams)
 ...
 // Anagrams with special characters ("Dormitory" and "Dirty Room")
...
//find c
 ...
 // predict the running time for a large input size
 ...
 largeArray2[i] = (int) (Math.random() * 10000); 
 }
 ...
 double actualTime2 = (endTime2 - startTime2) / 1000.0;
 ...
 String[] expectedGroup = {"Reacts/acerst", "crates/acerst", "caster/acerst", "Caters/acerst", "carets/acerst"};
