...
public class MergeSort<E extends Comparable<E>> {
    ...
    public E[] sort(E[] array) {
        ...
        E[] tempArray = sorted.clone();
        sort(sorted, tempArray, 0, array.length - 1);
        return sorted;
    }
    ...
    */
     ...
     *
     * @param array1 the input array containing two sorted subarrays
     * @param array2 a temporary array used for merging
    ...
    private void merge(E[] array1, E[] array2, int first, int middle, int last) {
        ...
        // Merge two sorted subarrays into array2
        while (leftIndex <= middle && rightIndex <= last) {
            if (array1[leftIndex].compareTo(array1[rightIndex]) <= 0) {
                array2[i++] = array1[leftIndex++];
            } else {
                array2[i++] = array1[rightIndex++];
            }
        }
        ...
        // Copy merged subarrays back to array1
        System.arraycopy(array2, first, array1, first, last - first + 1);
    }
