...
public class MergeSort<E extends Comparable<E>> {
    ...
    public double O(int n) {
    	...
    	return Math.log(n) / Math.log(2) * n; // O(n log n)
    ...
    public void fit(E[] array) {
        // TODO: Assignment Part 3.2
         ...
         sort(array); // Run the sort to measure time
         ...
         c = timeTaken / O(n); // c = time / (n log n)
    }
    ...
    private void sort(E[] array1, E[] array2, int first, int last) {
        ...
        while (a <= middle && b <= last) {
            // EXERCISE
        	if (((Comparable<E>) array1[a]).compareTo(array1[b]) <= 0) {
                // Copy array1[a] to array2[i] and increment a and i
                array2[i++] = array1[a++];
            } else {
                // Copy array1[b] to array2[i] and increment b and i
                array2[i++] = array1[b++];
            }
