...
public class InsertionSort<E extends Comparable<E>> {
    ...
    public void fit(E[] array) {
        ...
        double timeTaken = (end - start) / 1000.0;//microseconds (1 microsecond = 1000 nanoseconds)
        c = timeTaken / O(array.length);
    ...
    public E[] sort(E[] array) {
    	...
    	/* Handle case where length of array is 1 or less - means its already sorted */
        if(array.length <=1) {
        	return array;//returns og array
        }
       

        //makes copy of the array to sort
