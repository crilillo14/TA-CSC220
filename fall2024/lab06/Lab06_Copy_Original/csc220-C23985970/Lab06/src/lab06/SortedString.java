...
public class SortedString implements Comparable<SortedString> {
    ...
    public SortedString(String unsorted) {
        // TODO: Lab Part 1.1
    	//set unsorted and sorted to something
    //takes in an unsorted string and returns a sorted string
    	
    	this.unsorted = unsorted;
    	
    	//make lower case
    	String lowercaseUnsorted = this.unsorted.toLowerCase();
    	
    	//turn into array
    	char[] unsortedLowercaseArray = lowercaseUnsorted.toCharArray();
    	
    	
    	//sort char array
    	Arrays.sort(unsortedLowercaseArray);
    		
    	
    	this.sorted = new String(unsortedLowercaseArray);	
    ...
    public int compareTo(SortedString other) {
        // TODO: Lab Part 1.2
    	//compares the already sorted words
    	//since we implemented comparable, we must have a compareTo method
