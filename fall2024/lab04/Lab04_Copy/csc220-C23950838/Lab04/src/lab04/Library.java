 ...
 * 
 */
public class Library<GenType> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)

  protected ArrayList<LibraryBook<GenType>> library;

  public Library() {
    library = new ArrayList<LibraryBook<GenType>>();
  }
  ...
  public void add(long isbn, String author, String title) {
    library.add(new LibraryBook<GenType>(isbn, author, title));
  }
   ...
   */
  public void addAll(ArrayList<LibraryBook<GenType>> list) {
    library.addAll(list);
  }
  ...
  public void addAll(String filename) {
    ArrayList<LibraryBook<GenType>> toBeAdded = new ArrayList<LibraryBook<GenType>>();
    ...
    try {
      ...
      while (fileIn.hasNextLine()) {
        ...
        toBeAdded.add(new LibraryBook<GenType>(isbn, author, title));
   ...
   */
  public GenType lookup(long isbn) {
   ...
   */
  public ArrayList<LibraryBook<GenType>> lookup(GenType holder) {
    // *FILL IN -- do not return null
	  ArrayList<LibraryBook<GenType>>  CheckedOutList = new ArrayList<LibraryBook<GenType>>();
	  if (library.size() == 0)
		  return CheckedOutList;
	  for (int i = 0; i < library.size(); i++){
		  GenType BookHolder = library.get(i).getHolder();
   ...
   */
  public boolean checkout(long isbn, GenType holder, int month, int day, int year) {
   ...
   */
  public boolean checkin(GenType holder) {
	    // *FILL IN -- do not return false unless appropriate	  
	int counter = 0;
	for (int i = 0; i < library.size(); i++){
  ...
  // TODO: Uncomment the code below for Lab part 4
    ...
    */
   public ArrayList<LibraryBook<GenType>> getInventoryList() {
     ArrayList<LibraryBook<GenType>> libraryCopy = new ArrayList<LibraryBook<GenType>>();
    ...
    */
   protected class IsbnComparator implements Comparator<LibraryBook<GenType>> {

	@Override
	public int compare(LibraryBook<GenType> book1, LibraryBook<GenType> book2) {
...
//   *********************************************************************
    ...
    */
   public List<LibraryBook<GenType>> getOrderedByAuthor() {
    ...
    */
   public List<LibraryBook<GenType>> getOverdueList() {
       // TODO Assignment part 2
	   
	   ArrayList<LibraryBook<GenType>> lateBooks = new ArrayList<LibraryBook<GenType>>();
	   
	   int index;
	   GregorianCalendar currentDate = new GregorianCalendar();
	   
	   for (index = 0; index < library.size(); ++index) {
		   if ((library.get(index).getDueDate() != null) && (library.get(index).getDueDate().compareTo(currentDate) < 0)) {
			   lateBooks.add(library.get(index));
		   }
	   }
	   
	   DueDateComparator comparator = new DueDateComparator();
	   
	   sort(lateBooks, comparator);
    ...
    */
   protected class AuthorComparator implements Comparator<LibraryBook<GenType>> {
    ...
    */
   protected class DueDateComparator implements Comparator<LibraryBook<GenType>> {
