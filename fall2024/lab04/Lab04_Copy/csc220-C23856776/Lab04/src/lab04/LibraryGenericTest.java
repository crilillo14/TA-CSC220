...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<LibraryBook<String>> inventoryList1 = lib1.getInventoryList();
     ...
     if (inventoryList1.get(0).getIsbn() != 9780330351690L || inventoryList1.get(1).getIsbn() != 9780374292799L) {
         System.err.println("Test failed: getInventoryList for lib1");
     }
    	 
     
     if (lib1.checkout(9999999999999L, "Nonexistent Patron", 1, 1, 2008))
         System.err.println("TEST FAILED: checkout for nonexistent book");
     
     if (lib1.checkin(9999999999999L))
         System.err.println("TEST FAILED: checkin for nonexistent book");

     if (lib1.lookup(9780446580342L) != null)
         System.err.println("TEST FAILED: lookup for non-checked-out book");
