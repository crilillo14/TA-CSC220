...
public class Library<Type> { 
  ...
  public Type lookup(long isbn) {
    ...
    return null; // only if there is no book with the isbn
  }
   ...
   */
  public boolean checkout(long isbn, Type holder, int month, int day, int year) { // holder type
   ...
   */
  public boolean checkin(Type holder) { // the generic holder
  ...
  //  */
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	   ...
	   public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		   ...
		   int authorComparison = book1.getAuthor().compareTo(book2.getTitle());
   ...
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
	   ...
	   public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		   ...
		   if (book1.getDueDate() == null && book2.getDueDate() == null) {
			   ...
			   return 0; // considers them as equal
