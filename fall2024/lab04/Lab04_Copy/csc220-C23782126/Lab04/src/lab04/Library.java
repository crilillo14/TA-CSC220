...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  //  */
   public ArrayList<LibraryBook<Type>> getOrderedByAuthor() {
	   ...
	   ArrayList<LibraryBook<Type>> libraryCopyAuthor = new ArrayList<LibraryBook<Type>>();
	   libraryCopyAuthor.addAll(library);
	   AuthorComparator aComparator = new AuthorComparator();
	   sort(libraryCopyAuthor, aComparator);
	   return libraryCopyAuthor;
  ...
  //  */
   ...
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
     // TODO: Assignment Part 1
	   public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		   int authorsCompared = book1.getAuthor().compareTo(book2.getAuthor());
		   if(authorsCompared == 0) {
			   return book1.getTitle().compareTo(book2.getTitle());
		   }
		   return authorsCompared;
	   }
