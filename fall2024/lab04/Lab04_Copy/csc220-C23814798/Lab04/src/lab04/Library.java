...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
 ...
 protected class IsbnComparator implements Comparator<LibraryBook<Type>> {
     ...
     public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
         return Long.compare(book1.getIsbn(), book2.getIsbn());  // Compare books by ISBN
     }
 }
  ...
  //     // TODO Assignment part 1
	    ...
	    sort(libraryCopy, comparator);  // Sort the books using the comparator
	    return libraryCopy;
   }
  ...
  //     // TODO Assignment part 2
		    ...
		    // Only include books that are overdue (i.e., due date is earlier than the current date)
		    for (LibraryBook<Type> book : library) {
		        if (book.getDueDate() != null && book.getDueDate().compareTo(new GregorianCalendar()) < 0) {
		            overdueBooks.add(book);
		        }
		    }

		    // Sort the overdue books using the DueDateComparator
