...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    Library<PhoneNumber> libTest = new Library<PhoneNumber>();
    libTest.add(123L, "Thomas L. Friedman", "The World is Flat");
    libTest.add(567L, "Jon Krakauer", "Into the Wild");
    libTest.add(678L, "David Baldacci", "Simple Genius");
    libTest.add(456L, "Test author 1", "Test Book Small");
    libTest.add(234L, "Test author 2", "Test Book Large");
    libTest.add(345L, "Test author 3", "Test Book Medium");
