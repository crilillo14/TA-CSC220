...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    lib3 = new Library<String>();
    lib3.add(1111111111111L, "Book A", "Author A");
    lib3.add(2222222222222L, "Book B", "Author B");
    lib3.add(3333333333333L, "Book C", "Author C");
    inventory = lib3.getInventoryList();
