...
public class LibraryGenericTest {
 ...
 /*
   ...
   System.out.println("Authors in ABC order: " +lib3.getOrderedByAuthor());
   System.out.println("Inventory list: " + lib3.getInventoryList() );
  
   
  
   
   ArrayList<LibraryBook<String>> person1 = new ArrayList<LibraryBook<String>>();
   ...
   lib3.add(9780446580342L, "David Baldacci", "Simple Genius");   
    ...
    lib3.checkout(9781843193319L, "Sofia", 3, 2, 2001);
    System.out.println(lib3.getOverdueList(3, 1, 2006));
   ...
   */
   ...
   /*
    ...
    if (!(inventory.get(0).getIsbn()<inventory.get(1).getIsbn() && inventory.get(1).getIsbn()<inventory.get(2).getIsbn())) 
		System.out.println("Test Failed: getInventory()");
