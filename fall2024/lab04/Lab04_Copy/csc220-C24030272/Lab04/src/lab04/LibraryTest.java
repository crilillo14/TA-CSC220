...
public class LibraryTest {
  ...
  public static void main(String[] args) {
    ...
    lib.checkout(9781843190004l, "Jane Doe", 1, 1, 2008);
    lib.checkout(9781843190349l, "Jane Doe", 1, 1, 2008);
    lib.checkout(9781843190998l, "Jane Doe", 1, 1, 2008);
    lib.checkout(9781843193319l, "Jane Doe", 1, 1, 2008);
    lib.checkout(9781843190011l, "Jane Doe", 12, 12, 2025);
    System.out.println(lib.getInventoryList()); //testing get inventory
    System.out.println(lib.getOrderedByAuthor()); //testing ordered by author
    System.out.println(lib.getOverdueList()); //should have four books
    lib.checkin("Jane Doe"); //checks in all of jane's books
    System.out.println(lib.getOverdueList()); //should be empty now
