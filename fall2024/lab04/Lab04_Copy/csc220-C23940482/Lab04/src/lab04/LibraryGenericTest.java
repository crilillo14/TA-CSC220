...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    libTest.add(5, "Thomas L. Friedman", "The World is Flat");
    libTest.add(1, "Jon Krakauer", "Into the Wild");
    libTest.add(9, "David Baldacci", "Simple Genius");
    libTest.add(1, "John Doe", "Book 1");
    
    
    ArrayList<LibraryBook<String>> testLibrary = libTest.getInventoryList();
    ...
    lib3.checkout(9781843190004L, "Julian", 12, 4, 1992);
    lib3.checkout(9781843190011L, "Eric", 12, 4, 1234);
    lib3.checkout(9781843190028L, "Bruno", 11, 24, 2004);
        
    for(LibraryBook<String> b : lib3.getOverdueList()) {
