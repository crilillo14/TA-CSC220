...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(lib3.checkout(9780330351690L, patron1, 1, 1, 2008));
    ...
    lib4.add(922984922, "greg", "hello");
    lib4.checkout(922984922, "george", 2024, 8, 12);
    lib4.add(922984920, "gregi", "hello w");
    lib4.checkout(922984920, "gregi", 2024, 7, 10);
    lib4.checkout(922984920, "josh", 2024, 9, 16);
    lib4.checkout(922984920, "sam", 2024, 7, 10);
    
    System.out.println(lib4.getInventoryList());
    System.out.println(lib4.getOrderedByAuthor());
    System.out.println(lib4.getOverdueList());
    lib4.checkin(922984920);
    System.out.println(lib4.getInventoryList());
    System.out.println(lib4.getOrderedByAuthor());
    System.out.println(lib4.getOverdueList());
  }
