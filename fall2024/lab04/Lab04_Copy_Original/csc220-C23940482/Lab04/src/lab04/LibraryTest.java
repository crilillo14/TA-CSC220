...
public class LibraryTest {
  ...
  public static void main(String[] args) {
    ...
    Library<String> libx = new Library<String>();
    libx.add(123L, "Mark", "A");
    libx.add(423L, "Julian", "G");
    libx.add(153L, "Beatrice", "D");
    libx.add(113L, "Aj", "S");
    libx.add(723L, "Fillip", "V");
    libx.add(125L, "Mark", "B");   
    libx.add(123L, "Mark", "C");
   
    for(LibraryBook<String> b : libx.getOrderedByAuthor()) {
    	System.out.println(b);
    }
    for(LibraryBook<String> b : libx.getInventoryList()) {
    	System.out.println(b);
    }
