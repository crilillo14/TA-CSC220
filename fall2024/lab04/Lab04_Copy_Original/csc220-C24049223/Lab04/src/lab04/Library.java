  ...
  // *********************************************************************
   ...
   public ArrayList<LibraryBook<Type>> getOverdueList() {
	   ...
	   for (int i = 0; i < libraryCopy.size(); i++) {
		   ...
		   LibraryBook<Type> book = libraryCopy.get(i);
		   if (book.getDueDate() == null) {
			   
			   libraryCopy.remove(i);
			   i--;
		   } else if (book.getDueDate().compareTo(new GregorianCalendar()) > 0) {
   ...
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
     // TODO: Assignment Part 1
	   public int compare(LibraryBook<Type> b1, LibraryBook<Type> b2) {
		   ...
		   int diff = b1.getAuthor().compareTo(b2.getAuthor());
   ...
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
     ...
     // TODO: Assignment Part 2
	   public int compare(LibraryBook<Type> b1, LibraryBook<Type> b2) {
		   ...
		   int diff = b1.getDueDate().compareTo(b2.getDueDate());
