...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    Library<String> lib10 = new Library<String>();
    lib10.add(3, "D", "p1");
    lib10.add(15, "A", "p2");
    lib10.add(21, "AB", "p3");
    lib10.add(541, "AA", "p4");
    ...
    lib10.checkout(3, "Tom", 9, 25, 2024);
    lib10.checkout(15, "Tom", 3, 20, 2024);
    lib10.checkout(21, "Tom", 8, 20, 2024);
    lib10.checkout(541, "Tom", 9, 15, 2024);
    lib10.checkout(11, "Tom", 9, 20, 2023);
    lib10.checkout(31, "Tom", 7, 20, 2025);
    
    ArrayList<LibraryBook<String>> sorted = lib10.getOverdueList();
    for (LibraryBook<String> book : sorted) {
    	
    	GregorianCalendar date = book.getDueDate();
    	System.out.println(date.get(GregorianCalendar.MONTH) + "/" + date.get(GregorianCalendar.DATE) + "/" + date.get(GregorianCalendar.YEAR) + " " + book.getIsbn());
    }
