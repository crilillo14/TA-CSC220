...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  public class IsbnComparator implements Comparator<LibraryBook<Type>> {
	  public int compare(LibraryBook<Type> part1, LibraryBook<Type> part2) {
		  return Long.compare(part1.getIsbn(), part2.getIsbn());
	  }
  }
  ...
  //  */
   public List<LibraryBook<Type>> getOrderedByAuthor() {
	   ...
	   ArrayList<LibraryBook<Type>> sorting = new ArrayList<LibraryBook<Type>>();
	   
	   AuthorComparator comparing = new AuthorComparator();
	   sorting.sort(comparing);
  ...
  //  */
   public List<LibraryBook<Type>> getOverdueList() {
	   ...
	   ArrayList<LibraryBook<Type>> overdue = new ArrayList<LibraryBook<Type>>();
  ...
  //  */
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
     // TODO: Assignment Part 1
	   public int compare(LibraryBook<Type> part1, LibraryBook<Type> part2) {
		   int comparison = part1.getAuthor().compareTo(part2.getAuthor());
  ...
  //  */
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
     // TODO: Assignment Part 2
	   public int compare(LibraryBook<Type> part1, LibraryBook<Type> part2) {
		   return part1.getDueDate().compareTo(part2.getDueDate());
	   }
   }
}
