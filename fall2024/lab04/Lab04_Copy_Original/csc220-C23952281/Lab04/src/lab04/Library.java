...
public class Library <Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  // *********************************************************************
   ...
   public List<LibraryBook<Type>> getOrderedByAuthor() {
	   ...
	   Collections.sort(libraryCopy, comparator);
   ...
   public List<LibraryBook<Type>> getOverdueList() {
	   ...
	   for (int i = 0; i < library.size(); i++) {
		   GregorianCalendar dueDate = library.get(i).getDueDate();
	   ...
	   Collections.sort(overdueBooks, comparator);
   ...
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	...
	public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		...
		if (book1.getAuthor().equals(book2.getAuthor())) {
			return (int) (book1.getTitle().compareTo(book2.getTitle()));
		}
		else return book1.getAuthor().compareTo(book2.getAuthor());
	}
     // TODO: Assignment Part 1
   ...
   //print method for test cases
   public void printOverdueBooks() {
	    // Get the list of overdue books
	    List<LibraryBook<Type>> overdueBooks = getOverdueList();
	    ...
	    if (overdueBooks.isEmpty()) {
	        ...
	        // Print out each overdue book
	        for (int i = 0; i < overdueBooks.size(); i++) {
	            LibraryBook<Type> book = overdueBooks.get(i);
	            System.out.println("Book " + (i + 1) + ":");
	            System.out.println("ISBN: " + book.getIsbn());
	            System.out.println("Title: " + book.getTitle());
	            System.out.println("Author: " + book.getAuthor());
	            System.out.println("Due Date: " + book.getDueDate().getTime()); // Prints the due date
	            System.out.println(); // Empty line between books
	        }
	    }
	}
}
