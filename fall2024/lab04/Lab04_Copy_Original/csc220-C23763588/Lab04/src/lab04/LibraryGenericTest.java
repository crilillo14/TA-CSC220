...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    lib4.add(9780374292799L, "Alan Fiore", "Very cool");
    ...
    // Verifying if the list is sorted by ISBN
    if (sortedInventory.size() != 3
        || sortedInventory.get(0).getIsbn() != 9780330351690L
        || sortedInventory.get(1).getIsbn() != 9780374292799L
        || sortedInventory.get(2).getIsbn() != 9780446580342L) {
