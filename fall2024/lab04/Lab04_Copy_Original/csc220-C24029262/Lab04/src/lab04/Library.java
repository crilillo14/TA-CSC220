...
public class Library <type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  */
  ...
  //class IsbnComparator implements Comparator <LibraryBook<type>> {
	  
	//  public int compare(LibraryBook<type> librarybook1,LibraryBook<type> librarybook2) {
	//	  return (int)(librarybook1.getIsbn()-librarybook2.getIsbn());
	 // }
//  }
  ...
  // // TODO: Lab Part 4 - write the compare method
	  ...
	  // public int compare(LibraryBook <type> obj1, LibraryBook <type> obj2) {
		//   if (obj1.getIsbn() - obj2.getIsbn() == 0) {
			//   return 0;
  ...
  //     // TODO Assignment part 1
	   ArrayList<LibraryBook<type>> orderedAuthor = new ArrayList<LibraryBook<type>>();
	   orderedAuthor.addAll(library);
	   AuthorComparator comparator = new AuthorComparator();
	   sort(orderedAuthor, comparator);
	   return orderedAuthor;
   }
  ...
  // TODO Assignment part 2
	   ...
	   for(int i = 0; i<library.size(); i++) {
		   if(library.get(i).dueDate != null && library.get(i).dueDate.compareTo(today)< 0) {
  ...
  //   // TODO: Assignment Part 1
	   public int compare(LibraryBook <type> obj1, LibraryBook <type> obj2) {
		   if(obj1.getAuthor().compareTo(obj2.getAuthor()) == 0){
  ...
  //   // TODO: Assignment Part 2
     public int compare(LibraryBook<type> obj1, LibraryBook<type> obj2) {
    	 if(obj1.getDueDate().compareTo(obj2.getDueDate()) == 0) {
    		 return 0;
    	 }
    	 if(obj1.getDueDate().compareTo(obj2.getDueDate())<0) {
    		 return -1;
