...
//  // }
  ...
  //  // TODO Assignment part 2
	   ...
	   GregorianCalendar todaysDate = (GregorianCalendar) Calendar.getInstance();
	   
	   for(LibraryBook<Type> book : library) {
		   if(book.getDueDate() != null && book.getDueDate().compareTo(todaysDate) <0 ) {
  ...
  protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	  ...
	  public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		  ...
		  if((int)(book1.getAuthor().compareTo(book2.getAuthor()))==0) {
			  return (int)(book1.getTitle().compareTo(book2.getTitle()));
			  
		  }
		  
		  return (int)(book1.getAuthor().compareTo(book2.getAuthor()));
  ...
  //   // TODO: Assignment Part 2
	   public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
	        ...
	        // Handle case where one or both due dates are null
//	        if (dueDate1 == null && dueDate2 == null) {
//	            return 0; // Both have no due date, consider them equal
//	        } else if (dueDate1 == null) {
//	            return 1; // Book1 has no due date, consider it "greater"
//	        } else if (dueDate2 == null) {
//	            return -1; // Book2 has no due date, consider it "greater"
//	        }
