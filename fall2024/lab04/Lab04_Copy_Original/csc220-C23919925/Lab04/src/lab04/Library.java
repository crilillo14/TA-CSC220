...
public class Library<Type> { // TODO: Lab Part 2 Make the Library class generic (don't forget to update the
    ...
    // **********************************************************************
    /**
     * Retrieves a list of library books sorted by the author's full name. If
     * two books have the same author, the tie is broken by the book title.
     *
     * The sorting is performed using the AuthorComparator class, which compares
     * the full author strings and then compares titles if the authors are the
     * same.
     *
    ...
    protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
        ...
        public int compare(LibraryBook<Type> a1, LibraryBook<Type> a2) {
            ...
            int author_difference = (int) (a1.getAuthor().compareTo(a2.getAuthor()));
            if (author_difference == 0) {
                return (int) (a1.getTitle().compareTo(a2.getTitle()));
            }
            return author_difference;
        }
    }
