...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  //     // TODO Assignment part 1
	  List<LibraryBook<Type>> listCopy = new ArrayList<>(library);
	  
	  AuthorComparator authorCompare = new AuthorComparator();
	  
	  listCopy.sort(authorCompare);
  ...
  //     // TODO Assignment part 2
	  List<LibraryBook<Type>> overDue = new ArrayList<>(library);
	  ...
	  overDue.sort(dueDateComparator);
  ...
  //   // TODO: Assignment Part 2
	  ...
	  public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
	        ...
	        // Handle the case where both due dates are null
	        if (dueDate1 == null && dueDate2 == null) {
	            return 0;
	        }
	        // Handle the case where only one due date is null
	        if (dueDate1 == null) {
	            return 1; // Consider books with null due dates as greater (come after) the ones with actual due dates
	        }
	        if (dueDate2 == null) {
	            return -1; // Consider books with null due dates as greater (come after) the ones with actual due dates
	        }

	        // Both due dates are non-null, compare them
