...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (booksCheckedOut1 == null
        ...
        || !booksCheckedOut1.get(0).getTitle().equals("Into the Wild")
        || !booksCheckedOut1.get(1).getTitle().equals("The World is Flat")
    ...
    if (booksCheckedOut2 == null
        ...
        || !booksCheckedOut2.get(0).getTitle().equals("Into the Wild")
        || !booksCheckedOut2.get(1).getTitle().equals("The World is Flat")
    ...
    // Additional tests for getInventoryList
    ArrayList<LibraryBook<String>> inventoryList = lib1.getInventoryList();
    if (inventoryList.size() != 3
        || !inventoryList.get(0).getIsbn().equals(9780330351690L)  // smallest ISBN first
        || !inventoryList.get(1).getIsbn().equals(9780374292799L)
        || !inventoryList.get(2).getIsbn().equals(9780446580342L))
