  ...
  //  */
  		...
  		public List<LibraryBook<Type>> getOrderedByAuthor() {
  		  //     // TODO Assignment part 1
  			...
  			ArrayList<LibraryBook<Type>> libraryByAuthor = new ArrayList<>(library);
  		    
  		    // Use the AuthorComparator to sort the books by author (and title if needed)
  		    AuthorComparator authorComparator = new AuthorComparator();
  		    
  		    // Use the selection sort method provided earlier
  		    sort(libraryByAuthor, authorComparator);
   ...
   // TODO Assignment part 2
	  ...
	  ArrayList<LibraryBook<Type>> overdueBooks = new ArrayList<>();
	    ...
	    for (LibraryBook<Type> book : library) {
	        ...
	        if (dueDate != null && dueDate.compareTo(currentDate) < 0) {
