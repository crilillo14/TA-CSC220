...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  // // TODO: Lab Part 4 - write the compare method
	   public int compare(LibraryBook<Type> object1, LibraryBook<Type> object2) {
	   if(object1.getIsbn() - object2.getIsbn() < 0) {
		   return -1;
	   }
	   else if(object1.getIsbn() - object2.getIsbn() == 0) {
		   return 0;
	   }else if(object1.getIsbn() - object2.getIsbn() > 0) {
		   return 1;}
	   return 0;
  ...
  //     // TODO Assignment part 1
	   ArrayList<LibraryBook<Type>> authorList = new ArrayList<LibraryBook<Type>>();
  ...
  //  */
   public List<LibraryBook<Type>> getOverdueList() {
	   ...
	   for(int index = 0; index < library.size(); index++) {
		   GregorianCalendar dateDue =  library.get(index).dueDate;
		   if(dateDue != null && dateDue.compareTo(today) < 0) {
			   overdueBooks.add(library.get(index));
		   }
	   }
  ...
  protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	  public int compare(LibraryBook<Type> object1, LibraryBook<Type> object2) {
		  if( object1.getAuthor().compareTo(object2.getAuthor()) == 0 ) {
			  int title = object1.getTitle().compareTo(object2.getTitle());
			  if(title < 0) {
				return -1;
			  }else {
				  return 1;
		  ...
		  else if(object1.getAuthor().compareTo(object2.getAuthor()) < 0) {
			  return -1;
		  }else {
			  return 1;
		  }
  ...
  //  */
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
	   public int compare(LibraryBook<Type> object1, LibraryBook<Type> object2) {
		   if(object1.getDueDate().compareTo(object2.getDueDate()) < 0) {
			   return -1;
		   }
		   else if(object1.getDueDate().compareTo(object2.getDueDate()) == 0) {
			   return 0;
		   }else{
			   return 1;}
	   }
