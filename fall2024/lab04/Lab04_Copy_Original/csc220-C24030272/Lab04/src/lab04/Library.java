...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  // // TODO: Lab Part 4 - write the compare method
	   //if first is bigger, return +, if first is smaller, return -, if =, return 0
	@Override
  ...
  //     // TODO Assignment part 2
	   ...
	   for (int i = 0; i< library.size();i++)
	   {
		   ...
		   {
			   if(Calendar.getInstance().compareTo(library.get(i).getDueDate())>0)
			   {
  ...
  //  */
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	...
	{
		// TODO Auto-generated method stub
		int comparison = o1.getAuthor().compareTo(o2.getAuthor());
		if(comparison!=0)
		{
			return comparison;
		}
		else //the author's are the same
		{
