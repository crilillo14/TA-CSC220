   ...
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
     // TODO: Assignment Part 2  
	   ...
	   public  int compare(LibraryBook<Type> o1, LibraryBook<Type> o2) {
		   ...
		   if (dueDate1.get(GregorianCalendar.YEAR) == dueDate2.get(GregorianCalendar.YEAR)){
			   if (dueDate1.get(GregorianCalendar.MONTH) == dueDate2.get(GregorianCalendar.MONTH)){
				   if (dueDate1.get(GregorianCalendar.DATE) == dueDate2.get(GregorianCalendar.DATE)){
					   return 0;
					}
				   return dueDate1.get(GregorianCalendar.DATE) - dueDate2.get(GregorianCalendar.DATE);
				}
			   return dueDate1.get(GregorianCalendar.MONTH) - dueDate2.get(GregorianCalendar.MONTH);
			}
			return dueDate1.get(GregorianCalendar.YEAR) - dueDate2.get(GregorianCalendar.YEAR);
	   }
