...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
   ...
   System.out.println(lib1.getInventoryList());
    ...
    String patron3 = "Moyra Caldecott";
    String patron4 = "Carol E. Meacham";
    
    lib3.checkout(9781843190004L, patron3, 2, 2, 2023);
    lib3.checkout(9781843190936L, patron4, 2, 2, 2023);
    lib3.checkout(9781843190004L, patron3, 2, 2, 2023);
