...
public class LibraryBook <Type> extends Book { //TODO: Lab Part 1 Make the LibraryBook class generic (don't forget to update the holder)
	...
	public void checkout(Type holder, GregorianCalendar dueDate){
		this.holder = holder; //u cant change String to Type bcause u cannot use consttuctor that takes in variable// Type doesn't have a constructor that take variable u need to set it to equal to sth already type Type
