...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    Library<String> testerLibrary = new Library<String>();
    testerLibrary.add(100078430L, "Dr Seuss", "Green Eggs and Ham");
    testerLibrary.add(128127200L, "2024 Farmer's Almanac", "Farmer Joe");
    testerLibrary.add(344062058L, "Life For Sale", "Anonymous");
    testerLibrary.add(505455998L, "Life For Sale", "Anonymous");
    testerLibrary.add(180345991L, "Life For Sale", "Anonymous");
  
    //System.out.println(testerLibrary.getInventoryList());
