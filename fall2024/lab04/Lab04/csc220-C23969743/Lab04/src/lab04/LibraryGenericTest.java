...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    Library<String> lib31 = new Library<String>();    
    lib31.addAll("Mushroom_Publishing.txt");

    // Test sorting by author
    ArrayList<LibraryBook<String>> orderedByAuthor = lib31.getOrderedByAuthor();
    if (orderedByAuthor == null || orderedByAuthor.isEmpty()) {
      System.err.println("TEST FAILED: getOrderedByAuthor returned null or empty list");
    } else {
      // Print sorted books by author
    ...
    // Test getting overdue list
    GregorianCalendar currentDate = new GregorianCalendar(); // Set appropriate date
    ArrayList<LibraryBook<String>> overdueList = lib31.getOverdueList(currentDate);
    if (overdueList == null) {
      System.err.println("TEST FAILED: getOverdueList returned null");
    } else {
      // Print overdue books
