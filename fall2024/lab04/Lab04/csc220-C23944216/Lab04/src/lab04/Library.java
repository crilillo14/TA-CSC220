...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  //  */
   public List<LibraryBook<Type>> getOrderedByAuthor() {
	     ArrayList<LibraryBook<Type>> libraryAuth = new ArrayList<LibraryBook<Type>>();
	     libraryAuth.addAll(library);

	     AuthorComparator comparator = new AuthorComparator();

	     sort(libraryAuth, comparator);
  ...
  //  */
   public List<LibraryBook<Type>> getOverdueList() {
	     ArrayList<LibraryBook<Type>> libraryDueDate = new ArrayList<LibraryBook<Type>>();
	     libraryDueDate.addAll(library);
...
//	     }
  ...
  // /**
  //  * Comparator that defines an ordering among3	C library books using the due date.
  //  */
   protected class DueDateComparator implements Comparator<LibraryBook<Type>> {
	   public int compare(LibraryBook<Type> o1, LibraryBook<Type> o2) {
		   ...
		   if (o1.getDueDate().compareTo(o2.getDueDate()) > 0) {
			   return 1;
		   }else if (o1.getDueDate().compareTo(o2.getDueDate()) < 0) {
			   return -1;
		   }else {   
			   return 0;
		   }
		   }catch (NullPointerException e){
			   return -1;//put books without due dates at the end
		   }
	   }
	  }
  //   // TODO: Assignment Part 2
