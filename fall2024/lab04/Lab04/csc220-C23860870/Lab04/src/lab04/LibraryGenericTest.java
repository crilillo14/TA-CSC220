...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (inventoryList.get(0).getIsbn() != 9780330351690L ||
        ...
        System.err.println("TEST FAILED: getInventoryList is not sorted correctly by ISBN.");
    } else {
        System.out.println("TEST PASSED: getInventoryList is sorted correctly by ISBN.");
    }
