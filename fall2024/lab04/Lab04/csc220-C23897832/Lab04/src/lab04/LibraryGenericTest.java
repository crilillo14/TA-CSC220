...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (lib2.lookup(1234567890L) != null) {
    	System.err.println("TEST FAILED: lookup by invalid ISBN");
    }
    
    if (lib2.checkin(1234567890L)) {
    	System.err.println("TEST FAILED: checkin by invalid ISBN");
    }
    ...
    ArrayList<LibraryBook<String>> inventory = lib4.getInventoryList();
    
    if (inventory.size() != 0) {
    	System.err.println("TEST FAILED: empty library inventory list");
    }
    
    lib4 = new Library<String>();
    lib4.add(1111111111111L, "Book A", "Author A");
    lib4.add(2222222222222L, "Book B", "Author B");
    lib4.add(3333333333333L, "Book C", "Author C");
    inventory = lib4.getInventoryList();
    
    if (inventory.size() != 3
    		|| inventory.get(0).getIsbn() != 1111111111111L
    		|| inventory.get(1).getIsbn() != 2222222222222L
    		|| inventory.get(2).getIsbn() != 3333333333333L) {
    	System.err.println("TEST FAILED: sorted library inventory list");
    }
