...
public class Library<Type> { //TODO: Lab Part 2 Make the Library class generic (don't forget to update the holder)
  ...
  // *********************************************************************
   ...
   public List<LibraryBook<Type>> getOrderedByAuthor() {
	   ...
	   ArrayList<LibraryBook<Type>> newList = new ArrayList<LibraryBook<Type>>();
	   newList.addAll(library);
	   AuthorComparator comparator = new AuthorComparator();
	   sort(newList, comparator);
	   return newList;
   }
   ...
   public List<LibraryBook<Type>> getOverdueList() {
	   ...
	   ArrayList<LibraryBook<Type>> newList = new ArrayList<LibraryBook<Type>>();
	   for (LibraryBook<Type> tempBook : library) {
		   if ((tempBook.getDueDate() != null) && ((tempBook.getDueDate().compareTo(new GregorianCalendar())) < 0)) {
			   newList.add(tempBook);
		   }
	   }
