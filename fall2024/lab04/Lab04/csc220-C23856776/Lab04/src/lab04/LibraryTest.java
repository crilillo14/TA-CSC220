...
public class LibraryTest {
  ...
  public static void main(String[] args) {
    ...
    // testing getOrderByAuthor for
    
    
    
    

//     test a medium library TODO: Assignment part 3 ***** DO THIS
    ...
    ArrayList<LibraryBook<String>> inventoryList3 = lib3.getInventoryList();
    
    System.out.println("Books in the medium library sorted by the ISBN: ");
    
    for (LibraryBook<String> book : inventoryList3) {
