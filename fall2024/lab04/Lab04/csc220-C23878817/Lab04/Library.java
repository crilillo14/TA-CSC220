  ...
  // *********************************************************************
   ...
   public ArrayList<LibraryBook<Type>> getOrderedByAuthor() {
       // TODO Assignment part 1
   	 ArrayList<LibraryBook<Type>> sortedBooks = new ArrayList<LibraryBook<Type>>();
   	 sortedBooks.addAll(library);
        // Sort the list using the AuthorComparator
   	 	AuthorComparator comparator = new AuthorComparator();
       sort(sortedBooks, comparator);
        return sortedBooks;
   }
   /**
   ...
   protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
	...
	public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
		...
		if(authorComparison != 0) {
			...
			//if different authors, return
		}
		return  title1.compareTo(title2); //if authors are the same
	}
     // TODO: Assignment Part 1
