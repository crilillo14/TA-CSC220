...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<LibraryBook<String>> inventory1 = lib1.getInventoryList();
    if (inventory1 == null || inventory1.size() != 3) {
        System.err.println("TEST FAILED: getInventoryList() - lib1");
    }

    //Testing to make sure the library is in the right order
    for (int i = 0; i < inventory1.size() - 1; i++) {
    	if (inventory1.get(i).getIsbn() > inventory1.get(i + 1).getIsbn()) {
    		System.out.println("TEST FAILED: Books out of order");
    	}
    }
