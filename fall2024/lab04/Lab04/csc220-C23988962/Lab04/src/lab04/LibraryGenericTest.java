...
public class LibraryGenericTest {
  ...
  public static void main(String[] args) {
    ...
    if (!lib3.checkout(9781843190004L, "Alice", 12, 12, 2024)) {
        System.err.println("TEST FAILED: Mushroom library checkout");
    }

    if (!lib3.checkin(9781843190004L)) {
        System.err.println("TEST FAILED: Mushroom library checkin");
    }

    ArrayList<LibraryBook<String>> sortedByISBN = lib3.getInventoryList();
    if (sortedByISBN == null || sortedByISBN.isEmpty()) {
        System.err.println("TEST FAILED: Mushroom library getInventoryList");
    }
