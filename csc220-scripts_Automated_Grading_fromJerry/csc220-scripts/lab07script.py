...
students = [line.strip().split(',') for line in open(
	'/Users/jerrybonnell/Documents/TA/fall2017/csc220-names.csv')]

distadd = "/Users/Jerry/Box Sync/"
assignment = "Lab07"
assignmentfiles = ["Postfixer.java", "StringSplitter.java"]
disk_main_add = "/Users/jerrybonnell/Documents/TA/fall2017/"
compile_files = ["Postfixer.java", "StringSplitter.java"]
main_file = "CheckLab.java"
main_class = "CheckLab"
actual_point = [15, 5, 10, 5, 35, 30]
...
def assignment_checking_rubric_all(filename, student=None, points=None, is_late=False):
	...
	if points is None:
		...
		file.write("Last Name, First Name, Lab ID, Submitted, Correct Submission, " +
				   "Compiles, Runs, InfixEvaluator(), PostfixConvertor(), " +
				   "Signature Penalty, Total")
	else:
		file = open(filename, "a+")
...
def check_assignment_for_student(dist_disk):
	...
	compile(10 points)
	run(5 points)
	InfixEvaluator(35 points)
	PostfixConvertor(30 points)
	"""
	...
	submission_status = ["Submitted", "Correct Submission", "Compiles",
						 "Runs", "InfixEvaluator()", "PostfixConvertor()"]
	...
	for student in students:
		...
		if is_copy:
			...
			src_main = "/Users/jerrybonnell/Documents/workspace/TA/src/" + assignment.lower() + \
				"/" + main_file
