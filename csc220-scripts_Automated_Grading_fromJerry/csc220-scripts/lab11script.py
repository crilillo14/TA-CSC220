...
assignment = "Lab11"
assignmentfiles = ["QuadraticProbingHashTable.java", "HashEntry.java"]
disk_main_add = "/Users/Jerry/Documents/TA/fall2017/"
compile_files = ["QuadraticProbingHashTable.java", "HashEntry.java"]
main_file = "CheckLab.java"
main_class = "CheckLab"
actual_point = [15, 5, 10, 5, 7, 10, 12, 12, 12, 12]
...
def assignment_checking_rubric_all(filename, student=None, points=None, is_late=False):
    ...
    if points is None:
        ...
        file.write("Last Name, First Name, Lab ID, Submitted, Correct Submission, " +
                   "Compiles, Runs, Constructor(), hash(), insert(), rehash(), " +
                   "remove(), find(), Signature Penalty, Total")
    else:
        file = open(filename, "a+")
...
def check_assignment_for_student(dist_disk):
    """
    [15, 5, 10, 5, 7, 10, 12, 12, 12, 12]
    submitted(15 points)
    correct submission(5 points)
    compile(10 points)
    run(5 points)
    constructor(7 points)
    hash(10 points)
    insert(12 points)
    rehash(12 points)
    remove(12 points)
    ...
    submission_status = ["Submitted", "Correct Submission", "Compiles",
                         "Runs", "constructor()", "hash()", "insert()", "rehash()",
                         "remove()", "find()"]
