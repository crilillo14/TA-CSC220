package lab04.lab04_3argOverdue;
...
public class Library<Type> { // TODO: Lab Part 2 Make the Library class generic (don't forget to update the
	...
	protected class IsbnComparator implements Comparator<LibraryBook<Type>> {
		...
		/**
		 * Compares two LibraryBooks and returns an integer depending on which one has a
		 * greater isbn. Returns 1 if book1 isbn is greater than book2 isbn, returns -1
		 * if book2 is greater, 0 if they are equal.
		 */
		public int compare(LibraryBook<Type> book1, LibraryBook<Type> book2) {
			return (int) (book1.getIsbn() - book2.getIsbn());
			// Casting is okay since ISBNs are similar orders of magnitude long
	...
	protected class AuthorComparator implements Comparator<LibraryBook<Type>> {
		...
		public int compare(LibraryBook<Type> o1, LibraryBook<Type> o2) {
			...
			// Tiebreaker
			if (diff == 0) {
				int titleDiff = o1.getTitle().compareTo(o2.getTitle());
				return titleDiff;
			}
