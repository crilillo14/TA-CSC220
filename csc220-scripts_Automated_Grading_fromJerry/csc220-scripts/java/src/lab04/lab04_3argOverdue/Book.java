...
public class Book {
	...
	public boolean equals(Object other) {
		...
		if (!(other instanceof Book)) // make sure the Object we're comparing to is a Matrix
			return false;
		Book b = (Book) other; // if the above was not true, we know it's safe to treat 'o' as a Matrix
