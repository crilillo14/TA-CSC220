...
assignment = "Lab09"
assignmentfiles = ["IntTree.java", "IntTreeNode.java", "IntTreeTester.java"]
disk_main_add = "/Users/Jerry/Documents/TA/fall2017/"
compile_files = ["IntTree.java", "IntTreeNode.java"]
...
def assignment_checking_rubric_all(filename, student=None, points=None, is_late=False):
    ...
    if points is None:
        ...
        file.write("Last Name, First Name, Lab ID, Submitted, Correct Submission, " +
                   "Compiles, Runs, countEmpty(), getLevel(), toString(), " +
                   "makePerfect(), Signature Penalty, Total")
    else:
        file = open(filename, "a+")
...
def check_assignment_for_student(dist_disk):
    ...
    compile(10 points)
    run(6 points)
    countEmpty(16 points)
    getLevel(16 points)
    toString(16 points)
    makePerfect(16 points)
    """
    ...
    submission_status = ["Submitted", "Correct Submission", "Compiles",
                         "Runs", "countEmpty()", "getLevel()", "toString()", "makePerfect()"]
    ...
    for student in students:
        ...
        if is_copy:
            ...
            assignment_checking_comments(
                ...
                + assignmentfiles[1] + " " + assignmentfiles[2] + "\n")
